import { s as Xs } from "./index-d475d2ea.js";
import { R as st, r as et } from "./index-8db94870.js";
import { u as qr, r as Js } from "./react-18-f58e807b.js";
import {
  u as Ks,
  b as Cn,
  c as $s,
...
import { g as Yt, c as Rt } from "./_commonjsHelpers-042e6b4d.js";
import { d as aa } from "./index-356e4a49.js";
var { FRAMEWORK_OPTIONS: qi } = Xs,
  Lh = (e, i) => {
  ...
  zr = qi != null && qi.strictMode ? et.StrictMode : et.Fragment;
async function Rh(
  {
    storyContext: e,
    unboundStoryFn: i,
  ...
  let m = st.createElement(
    ...
    x = zr ? st.createElement(zr, null, m) : m;
  return o && qr(l), await Js(x, l), () => qr(l);
}
var wn = { exports: {} },
    ...
    (k.prototype.traverse = function (u, w) {
      ...
      (k.prototype.replace = function (u, w) {
        ...
        function z(Be) {
          var tt, Ke, fe, Fe;
          if (Be.ref.remove()) {
            for (Ke = Be.ref.key, Fe = Be.ref.parent, tt = V.length; tt--; )
              if (((fe = V[tt]), fe.ref && fe.ref.parent === Fe)) {
                if (fe.ref.key < Ke) break;
                --fe.ref.key;
              }
          }
        }
...
function _a() {
  return (
    nn ||
      ...
      (Ut.SourceMapConsumer = ba().SourceMapConsumer),
      (Ut.SourceNode = Sa().SourceNode)),
    Ut
  );
}
const Ca = "escodegen",
  Ea = "ECMAScript code generator",
  wa = "http://github.com/estools/escodegen",
  ka = "escodegen.js",
  Aa = { esgenerate: "./bin/esgenerate.js", escodegen: "./bin/escodegen.js" },
  Ia = ["LICENSE.BSD", "README.md", "bin", "escodegen.js", "package.json"],
  Pa = "2.0.0",
  Ta = { node: ">=6.0" },
  Na = [
    {
  ...
  La = { type: "git", url: "http://github.com/estools/escodegen.git" },
  Ra = {
    estraverse: "^5.2.0",
    esutils: "^2.0.2",
    esprima: "^4.0.1",
...
`),
    ...
    function ai(a, d) {
      var c, p, b, L, F, M, Q, oe, ke, Ye, it, ui, hi, je;
...
` && (b = ["{"])),
        ...
        DirectiveStatement: function (a, d) {
          return N.raw && a.raw
            ...
            : Xe(a.directive) + this.semicolon(d);
        },
      ...
      (we.Expression = {
        ...
        ObjectPattern: function (a, d, c) {
          ...
          return (
            ...
            Ee(function (oe) {
              var ke, Ye;
              for (ke = 0, Ye = a.properties.length; ke < Ye; ++ke)
                p.push(F ? oe : ""),
                  p.push(Q.generateExpression(a.properties[ke], r.Sequence, z)),
                  ke + 1 < Ye && p.push("," + (F ? P : E));
            }),
...
` &&
    ...
    function ie(a, d) {
      ...
      return (
        ...
        (N = d),
        u &&
          (e.browser ? (o = Rt.sourceMap.SourceNode) : (o = _a().SourceNode)),
        (p = ct(a)),
        u
...
function Ot(e, i) {
  return e < 48
    ...
    ? !0
    : e <= 65535
    ? e >= 170 && Ua.test(String.fromCharCode(e))
    : i === !1
    ? !1
    : Yi(e, On) || Yi(e, Ga);
}
...
var We = { beforeExpr: !0 },
  ...
  ur = {};
function pe(e, i) {
  return i === void 0 && (i = {}), (i.keyword = e), (ur[e] = new ge(e, i));
}
var g = {
    num: new ge("num", qe),
...
Xt.prototype.offset = function (i) {
  return new Xt(this.line, this.column + i);
};
...
function Ha(e) {
  var i = {};
  for (var r in Zi) i[r] = e && _i(e, r) ? e[r] : Zi[r];
  if (
  ...
  return sn(i.onComment) && (i.onComment = Qa(i, i.onComment)), i;
}
function Qa(e, i) {
...
var an = 0,
  ...
  Te = function (i, r, s) {
    (this.options = i = Ha(i)),
      ...
      (this.keywords = bt(
        Da[i.ecmaVersion >= 6 ? 6 : i.sourceType === "module" ? "5module" : 5]
      ));
    var o = "";
...
Me.strictDirective = function (e) {
  for (;;) {
    (ze.lastIndex = e), (e += ze.exec(this.input)[0].length);
    var i = Xa.exec(this.input.slice(e));
    if (!i) return !1;
    if ((i[1] || i[2]) === "use strict") {
      ze.lastIndex = e + i[0].length;
      var r = ze.exec(this.input),
...
ne.isLet = function (e) {
  ...
  ze.lastIndex = this.pos;
  var i = ze.exec(this.input),
...
ne.isAsyncFunction = function () {
  ...
  ze.lastIndex = this.pos;
  var e = ze.exec(this.input),
    i = this.pos + e[0].length;
  return (
    !He.test(this.input.slice(this.pos, i)) &&
...
ne.parseFunctionStatement = function (e, i, r) {
  return this.next(), this.parseFunction(e, zt | (r ? 0 : er), !1, i);
};
...
ne.parseVarId = function (e, i) {
  (e.id = this.parseBindingAtom()),
    this.checkLVal(e.id, i === "var" ? cr : at, !1);
};
var zt = 1,
  er = 2,
  Qn = 4;
ne.parseFunction = function (e, i, r, s) {
  this.initFunction(e),
    (this.options.ecmaVersion >= 9 || (this.options.ecmaVersion >= 6 && !s)) &&
      (this.type === g.star && i & er && this.unexpected(),
    ...
    case "Identifier":
      i === at &&
        ...
        r &&
          ...
          (r[e.name] = !0)),
        i !== an && i !== Hn && this.declareName(e.name, i, e.start);
      break;
    case "ChainExpression":
      this.raiseRecoverable(
        e.start,
...
ae.parseMethod = function (e, i, r) {
  ...
  return (
    ...
    (this.awaitPos = 0),
    (this.awaitIdentPos = 0),
    this.enterScope(lr(i, s.generator) | Un | (r ? Gn : 0)),
    this.expect(g.parenL),
...
vi.curPosition = function () {
  if (this.options.locations)
    return new Xt(this.curLine, this.pos - this.lineStart);
};
var mt = Te.prototype,
  Ya = function (i) {
    (this.flags = i),
...
mt.treatFunctionsAsVarInScope = function (e) {
  return e.flags & ti || (!this.inModule && e.flags & Jt);
};
mt.declareName = function (e, i, r) {
  ...
  if (i === at) {
    ...
    (s =
      ...
      o.var.indexOf(e) > -1),
      o.lexical.push(e),
      this.inModule && o.flags & Jt && delete this.undefinedExports[e];
  } else if (i === zn) {
    ...
    for (var x = this.scopeStack.length - 1; x >= 0; --x) {
      ...
      if (
        (v.var.push(e),
        this.inModule && v.flags & Jt && delete this.undefinedExports[e],
        v.flags & hr)
      )
        break;
    }
...
mt.currentThisScope = function () {
  for (var e = this.scopeStack.length - 1; ; e--) {
    var i = this.scopeStack[e];
    if (i.flags & hr && !(i.flags & jn)) return i;
  }
};
var fr = function (i, r, s) {
    (this.type = ""),
      (this.start = r),
      (this.end = 0),
...
wi.startNode = function () {
  return new fr(this, this.start, this.startLoc);
};
wi.startNodeAt = function (e, i) {
  return new fr(this, e, i);
};
function Xn(e, i, r, s) {
  return (
    (e.type = i),
...
g._function.updateContext = g._class.updateContext = function (e) {
  ...
  e !== g._else &&
  !(
    e === g._return && He.test(this.input.slice(this.lastTokEnd, this.start))
  ) &&
...
function dr(e) {
  var i = (Zn[e] = {
    binary: bt(eo[e] + " " + on),
    nonBinary: { General_Category: bt(on), Script: bt(io[e]) },
  });
...
Y.regexp_eatQuantifier = function (e, i) {
  return (
    i === void 0 && (i = !1),
    this.regexp_eatQuantifierPrefix(e, i) ? (e.eat(63), !0) : !1
  );
};
Y.regexp_eatQuantifierPrefix = function (e, i) {
  return (
    e.eat(42) || e.eat(43) || e.eat(63) || this.regexp_eatBracedQuantifier(e, i)
  );
};
Y.regexp_eatBracedQuantifier = function (e, i) {
  var r = e.pos;
  if (e.eat(123)) {
    var s = 0,
      o = -1;
...
Y.regexp_eatRegExpIdentifierPart = function (e) {
  ...
  return (
    ...
    s === 92 &&
      this.regexp_eatRegExpUnicodeEscapeSequence(e, r) &&
      (s = e.lastIntValue),
    no(s) ? ((e.lastIntValue = s), !0) : ((e.pos = i), !1)
  );
};
function no(e) {
...
Y.regexp_eatRegExpUnicodeEscapeSequence = function (e, i) {
  i === void 0 && (i = !1);
  var r = e.pos,
    s = i || e.switchU;
  if (e.eat(117)) {
...
Y.regexp_eatCharacterClassEscape = function (e) {
  var i = e.current();
  if (ao(i)) return (e.lastIntValue = -1), e.advance(), !0;
...
Y.regexp_validateUnicodePropertyNameAndValue = function (e, i, r) {
...
Y.regexp_validateUnicodePropertyNameOrValue = function (e, i) {
...
Y.regexp_eatUnicodePropertyValue = function (e) {
  var i = 0;
  for (e.lastStringValue = ""; oo((i = e.current())); )
    (e.lastStringValue += yi(i)), e.advance();
  return e.lastStringValue !== "";
};
function oo(e) {
...
Y.regexp_eatFixedHexDigits = function (e, i) {
  var r = e.pos;
  e.lastIntValue = 0;
  for (var s = 0; s < i; ++s) {
    var o = e.current();
...
ce.skipBlockComment = function () {
  ...
  if (
    ...
    Qt.lastIndex = i;
    for (var s; (s = Qt.exec(this.input)) && s.index < this.pos; )
...
ce.readRegexp = function () {
  for (var e, i, r = this.pos; ; ) {
    ...
    if ((He.test(s) && this.raise(r, "Unterminated regular expression"), e))
      e = !1;
    else {
      if (s === "[") i = !0;
      else if (s === "]" && i) i = !1;
...
ce.readNumber = function (e) {
  ...
  r && /[89]/.test(this.input.slice(i, this.pos)) && (r = !1),
    ...
    ft(this.fullCharCodeAtPos()) &&
      this.raise(this.pos, "Identifier directly after number");
  var l = uo(this.input.slice(i, this.pos), r);
    ...
    un ||
      ...
      (function (e, i) {
        (function (r, s) {
          ...
          function Fe(t) {
            var n = {};
            for (var h in Ke) n[h] = t && Se(t, h) ? t[h] : Ke[h];
            if (
          ...
          (Z.parseTryStatement = function (t) {
            if (
              ...
              if ((this.next(), this.eat(u.parenL))) {
                ...
                this.enterScope(h ? Pe : 0),
                  this.checkLValPattern(n.param, h ? jt : Xe),
            ...
            (Z.parseVarId = function (t, n) {
              (t.id = this.parseBindingAtom()),
                this.checkLValPattern(t.id, n === "var" ? Dt : Xe, !1);
            });
          var _e = 1,
            Pt = 2,
            oi = 4;
            ...
            (Z.parseClassId = function (t, n) {
              this.type === u.name
                ? ((t.id = this.parseIdent()),
                  n && this.checkLValSimple(t.id, Xe, !1))
            ...
            (Z.parseImportSpecifiers = function () {
              ...
              if (this.type === u.name) {
                ...
                if (
                  ...
                  this.checkLValSimple(h.local, Xe),
              ...
              if (this.type === u.star) {
                ...
                return (
                  ...
                  this.checkLValSimple(f.local, Xe),
                ...
                (S.imported = this.parseModuleExportName()),
                  this.eatContextual("as")
                    ...
                    : (this.checkUnreserved(S.imported),
                      (S.local = S.imported)),
                  this.checkLValSimple(S.local, Xe),
...
`
          ...
          var Q =
            ...
            ke = oe,
            Ye = ke + " EBase EComp EMod EPres ExtPict",
            it = Ye,
            ui = it,
            hi = { 9: Q, 10: oe, 11: ke, 12: Ye, 13: it, 14: ui },
            je =
              "Cased_Letter LC Close_Punctuation Pe Connector_Punctuation Pc Control Cc cntrl Currency_Symbol Sc Dash_Punctuation Pd Decimal_Number Nd digit Enclosing_Mark Me Final_Punctuation Pf Format Cf Initial_Punctuation Pi Letter L Letter_Number Nl Line_Separator Zl Lowercase_Letter Ll Mark M Combining_Mark Math_Symbol Sm Modifier_Letter Lm Modifier_Symbol Sk Nonspacing_Mark Mn Number N Open_Punctuation Ps Other C Other_Letter Lo Other_Number No Other_Punctuation Po Other_Symbol So Paragraph_Separator Zp Private_Use Co Punctuation P punct Separator Z Space_Separator Zs Spacing_Mark Mc Surrogate Cs Symbol S Titlecase_Letter Lt Unassigned Cn Uppercase_Letter Lu",
            wr =
            ...
            Vs = Pr + " Kawi Nag_Mundari Nagm",
            Fs = { 9: wr, 10: kr, 11: Ar, 12: Ir, 13: Pr, 14: Vs },
            Tr = {};
          function Ms(t) {
            var n = (Tr[t] = {
              binary: te(hi[t] + " " + je),
              nonBinary: { General_Category: te(je), Script: te(Fs[t]) },
            });
          ...
          var $ = se.prototype,
            rt = function (n) {
              (this.parser = n),
                ...
                (this.unicodeProperties =
                  Tr[n.options.ecmaVersion >= 14 ? 14 : n.options.ecmaVersion]),
                (this.source = ""),
                (this.flags = ""),
                (this.start = 0),
                (this.switchU = !1),
          ...
          (rt.prototype.reset = function (n, h, f) {
            ...
            ($.validateRegExpFlags = function (t) {
              for (
            ...
            ($.validateRegExpPattern = function (t) {
            ...
            ($.regexp_alternative = function (t) {
              for (; t.pos < t.source.length && this.regexp_eatTerm(t); );
            }),
            ($.regexp_eatTerm = function (t) {
            ...
            ($.regexp_eatAssertion = function (t) {
              var n = t.pos;
              if (
            ...
            ($.regexp_eatQuantifier = function (t, n) {
              return (
                n === void 0 && (n = !1),
                this.regexp_eatQuantifierPrefix(t, n) ? (t.eat(63), !0) : !1
              );
            }),
            ($.regexp_eatQuantifierPrefix = function (t, n) {
              return (
                t.eat(42) ||
                t.eat(43) ||
                t.eat(63) ||
            ...
            ($.regexp_eatBracedQuantifier = function (t, n) {
              var h = t.pos;
              if (t.eat(123)) {
                var f = 0,
                  S = -1;
            ...
            ($.regexp_eatReverseSolidusAtomEscape = function (t) {
              var n = t.pos;
              if (t.eat(92)) {
            ...
            ($.regexp_eatUncapturingGroup = function (t) {
              var n = t.pos;
              if (t.eat(40)) {
            ...
            ($.regexp_eatCapturingGroup = function (t) {
              if (t.eat(40)) {
                if (
                  (this.options.ecmaVersion >= 9
            ...
            ($.regexp_eatExtendedAtom = function (t) {
              return (
                t.eat(46) ||
                this.regexp_eatReverseSolidusAtomEscape(t) ||
                this.regexp_eatCharacterClass(t) ||
            ...
            ($.regexp_eatInvalidBracedQuantifier = function (t) {
              return (
            ...
            ($.regexp_eatSyntaxCharacter = function (t) {
              var n = t.current();
              return Lr(n) ? ((t.lastIntValue = n), t.advance(), !0) : !1;
            });
          function Lr(t) {
            return (
              t === 36 ||
          ...
          ($.regexp_eatPatternCharacters = function (t) {
            for (var n = t.pos, h = 0; (h = t.current()) !== -1 && !Lr(h); )
              t.advance();
            return t.pos !== n;
          }),
            ($.regexp_eatExtendedPatternCharacter = function (t) {
              var n = t.current();
              return n !== -1 &&
                n !== 36 &&
                !(n >= 40 && n <= 43) &&
            ...
            ($.regexp_groupSpecifier = function (t) {
              if (t.eat(63)) {
            ...
            ($.regexp_eatGroupName = function (t) {
            ...
            ($.regexp_eatRegExpIdentifierName = function (t) {
              if (
                ((t.lastStringValue = ""),
            ...
            ($.regexp_eatRegExpIdentifierStart = function (t) {
              var n = t.pos,
              ...
              return (
                ...
                f === 92 &&
                  ...
                  (f = t.lastIntValue),
                Ds(f) ? ((t.lastIntValue = f), !0) : ((t.pos = n), !1)
              );
            });
          function Ds(t) {
            return P(t, !0) || t === 36 || t === 95;
          }
          $.regexp_eatRegExpIdentifierPart = function (t) {
            var n = t.pos,
              h = this.options.ecmaVersion >= 11,
              f = t.current(h);
            return (
              ...
              f === 92 &&
                this.regexp_eatRegExpUnicodeEscapeSequence(t, h) &&
                (f = t.lastIntValue),
              js(f) ? ((t.lastIntValue = f), !0) : ((t.pos = n), !1)
            );
          };
          function js(t) {
            return E(t, !0) || t === 36 || t === 95 || t === 8204 || t === 8205;
          }
          ($.regexp_eatAtomEscape = function (t) {
            ...
            ($.regexp_eatBackReference = function (t) {
              var n = t.pos;
            ...
            ($.regexp_eatKGroupName = function (t) {
              if (t.eat(107)) {
                if (this.regexp_eatGroupName(t))
            ...
            ($.regexp_eatCharacterEscape = function (t) {
              return (
            ...
            ($.regexp_eatCControlLetter = function (t) {
              var n = t.pos;
              if (t.eat(99)) {
            ...
            ($.regexp_eatControlLetter = function (t) {
              var n = t.current();
              return Rr(n) ? ((t.lastIntValue = n % 32), t.advance(), !0) : !1;
            });
          function Rr(t) {
            return (t >= 65 && t <= 90) || (t >= 97 && t <= 122);
          }
          $.regexp_eatRegExpUnicodeEscapeSequence = function (t, n) {
            n === void 0 && (n = !1);
            var h = t.pos,
              f = n || t.switchU;
            if (t.eat(117)) {
          ...
          ($.regexp_eatIdentityEscape = function (t) {
            if (t.switchU)
            ...
            ($.regexp_eatDecimalEscape = function (t) {
              t.lastIntValue = 0;
              var n = t.current();
              if (n >= 49 && n <= 57) {
                do
            ...
            ($.regexp_eatCharacterClassEscape = function (t) {
              var n = t.current();
              if (Us(n)) return (t.lastIntValue = -1), t.advance(), !0;
              if (
                t.switchU &&
                this.options.ecmaVersion >= 9 &&
                (n === 80 || n === 112)
          ...
          ($.regexp_eatUnicodePropertyValueExpression = function (t) {
            var n = t.pos;
            ...
            ($.regexp_validateUnicodePropertyNameAndValue = function (t, n, h) {
              Se(t.unicodeProperties.nonBinary, n) ||
                t.raise("Invalid property name"),
                t.unicodeProperties.nonBinary[n].test(h) ||
                  t.raise("Invalid property value");
            }),
            ($.regexp_validateUnicodePropertyNameOrValue = function (t, n) {
              t.unicodeProperties.binary.test(n) ||
                t.raise("Invalid property name");
            }),
            ($.regexp_eatUnicodePropertyName = function (t) {
              var n = 0;
              for (t.lastStringValue = ""; Or((n = t.current())); )
          ...
          $.regexp_eatUnicodePropertyValue = function (t) {
            var n = 0;
            for (t.lastStringValue = ""; Gs((n = t.current())); )
              (t.lastStringValue += Ae(n)), t.advance();
            return t.lastStringValue !== "";
          };
          function Gs(t) {
          ...
          ($.regexp_eatLoneUnicodePropertyNameOrValue = function (t) {
            return this.regexp_eatUnicodePropertyValue(t);
          }),
            ($.regexp_eatCharacterClass = function (t) {
              if (t.eat(91)) {
            ...
            ($.regexp_eatClassAtom = function (t) {
              var n = t.pos;
              if (t.eat(92)) {
                if (this.regexp_eatClassEscape(t)) return !0;
                if (t.switchU) {
                  var h = t.current();
                  (h === 99 || Mr(h)) && t.raise("Invalid class escape"),
                    t.raise("Invalid escape");
                }
                t.pos = n;
              }
            ...
            ($.regexp_eatClassEscape = function (t) {
              var n = t.pos;
            ...
            ($.regexp_eatClassControlLetter = function (t) {
              var n = t.current();
              return li(n) || n === 95
                ? ((t.lastIntValue = n % 32), t.advance(), !0)
                : !1;
            }),
            ($.regexp_eatHexEscapeSequence = function (t) {
              var n = t.pos;
              if (t.eat(120)) {
            ...
            ($.regexp_eatDecimalDigits = function (t) {
              var n = t.pos,
                h = 0;
          ...
          $.regexp_eatHexDigits = function (t) {
            var n = t.pos,
              h = 0;
            for (t.lastIntValue = 0; Vr((h = t.current())); )
              (t.lastIntValue = 16 * t.lastIntValue + Fr(h)), t.advance();
            return t.pos !== n;
          };
          function Vr(t) {
            return (
          ...
          ($.regexp_eatLegacyOctalEscapeSequence = function (t) {
            ...
            ($.regexp_eatOctalDigit = function (t) {
              var n = t.current();
              return Mr(n)
          ...
          $.regexp_eatFixedHexDigits = function (t, n) {
            var h = t.pos;
            t.lastIntValue = 0;
            for (var f = 0; f < n; ++f) {
              var S = t.current();
              if (!Vr(S)) return (t.pos = h), !1;
              (t.lastIntValue = 16 * t.lastIntValue + Fr(S)), t.advance();
            }
            return !0;
          };
          var ci = function (n) {
          ...
          (le.readRadixNumber = function (t) {
            ...
            return (
              ...
              this.input.charCodeAt(this.pos) === 110
                ? ((h = Br(this.input.slice(n, this.pos))), ++this.pos)
            ...
            (le.readNumber = function (t) {
              ...
              if (!h && !t && this.options.ecmaVersion >= 11 && f === 110) {
                var S = Br(this.input.slice(n, this.pos));
                return (
                  ++this.pos,
                  P(this.fullCharCodeAtPos()) &&
                    this.raise(this.pos, "Identifier directly after number"),
              ...
              h && /[89]/.test(this.input.slice(n, this.pos)) && (h = !1),
                ...
                P(this.fullCharCodeAtPos()) &&
                  this.raise(this.pos, "Identifier directly after number");
              var T = Ws(this.input.slice(n, this.pos), h);
          ...
          (le.tryReadTemplateToken = function () {
            ...
            try {
              ...
              if (t === Dr) this.readInvalidTemplateToken();
              else throw t;
            }
            this.inTemplateElement = !1;
          }),
...
function Co(e) {
  ...
  return typeof r == "function" && r instanceof r && ls.call(r) == _o;
}
var Eo = Co;
const wo = Yt(Eo);
var ko = Cn,
  ...
  Po = "[object String]";
function To(e) {
  return typeof e == "string" || (!Ao(e) && Io(e) && ko(e) == Po);
}
var No = To;
const Lo = Yt(No);
/*!
  ...
  return ln(e) === !1
    ...
    : ((i = e.constructor),
      i === void 0
        ? !0
        : ((r = i.prototype),
          !(ln(r) === !1 || r.hasOwnProperty("isPrototypeOf") === !1)));
}
var cs = {},
  bi =
    (Rt && Rt.__assign) ||
...
var ds = function (i) {
  ...
  $o = function (i) {
    switch (!0) {
      ...
      case typeof i.type == "function":
        return i.type.displayName ? i.type.displayName : ms(i.type);
  ...
  br = function e(i, r) {
    ...
    if (typeof i == "number") return Ho(i);
    ...
    var v = fn(i.type.defaultProps || {}, pn),
      C = st.Children.toArray(i.props.children)
        .filter(Yo)
        .map(function (_) {
          return e(_, r);
        });
    return Jo && i.type === et.Fragment ? Xo(x, C) : Qo(l, m, v, C);
  };
function Zo() {}
var eu = function (i) {
    return i
...
`.concat(nt(r + 1, s.tabStop), "$1")
  ...
  ru = function (i, r, s, o) {
    ...
    if (typeof i == "string") return '"'.concat(iu(i), '"');
    if (Kt(i) === "symbol") {
      var l = i
        .valueOf()
        .toString()
    ...
    return typeof i == "function"
      ? "{".concat(gs(i, o), "}")
      : et.isValidElement(i)
      ? "{".concat(Bi(br(i, o), !0, s, o), "}")
      : i instanceof Date
      ? isNaN(i.valueOf())
        ? "{new Date(NaN)}"
        : '{new Date("'.concat(i.toISOString(), '")}')
      : Ro(i) || Array.isArray(i)
      ? "{".concat(tu(i, r, s, o), "}")
      : "{".concat(String(i), "}");
  },
  nu = function (e, i, r, s, o, l, m, x) {
    if (!i && !s)
      throw new Error(
        'The prop "'.concat(
          e,
  ...
  su = function (e, i) {
    ...
    return (
      ...
      (s.type === "string" || s.type === "number")
        ? r.push(ds(String(s.value) + String(i.value)))
        : (s && r.push(s), r.push(i)),
      r
    );
  },
...
`)
  ...
  xs = function (i, r, s, o, l) {
    return l ? nt(s, o).length + r.length > l : i.length > 1;
  },
  pu = function (i, r, s, o, l, m, x) {
    return (xs(i, r, l, m, x) || s) && !o;
  },
  vs = function (e, i, r, s) {
    var o = e.type,
      l = e.displayName,
...
`),
  ...
  xu = function (e, i, r, s) {
    ...
    var x = s.useFragmentShortSyntax,
      v;
    return (
      x ? (gu(e) || mu(e) ? (v = mn) : (v = fu)) : (v = mn),
      vs(du(v, l, m), i, r, s)
    );
  },
  vu = ["<", ">", "{", "}"],
  yu = function (i) {
    return vu.some(function (r) {
      return i.includes(r);
    });
  },
  bu = function (i) {
    return yu(i) ? "{`".concat(i, "`}") : i;
  },
  Su = function (i) {
    var r = i;
    return (
  ...
  Bi = function (e, i, r, s) {
    ...
    if (e.type === "string")
      return e.value ? "".concat(Su(bu(String(e.value)))) : "";
    if (e.type === "ReactElement") return vs(e, i, r, s);
    if (e.type === "ReactFragment") return xu(e, i, r, s);
...
const {
    defaultDecorateStory: Cu,
    addons: Eu,
    useEffect: wu,
  } = __STORYBOOK_MODULE_PREVIEW_API__,
  { logger: gi } = __STORYBOOK_MODULE_CLIENT_LOGGER__;
function ku(e, i) {
  let r = e != null,
    s = i != null;
  if (!r && !s) return "";
...
var rr = "custom",
  ...
  Mt = "element";
function _r(e) {
  return ma.includes(e.toLowerCase());
}
var ys = { format: { indent: { style: "  " }, semicolons: !1 } },
  Tu = { ...ys, format: { newline: "" } },
  Nu = { ...ys };
function pt(e, i = !1) {
  return In.generate(e, i ? Tu : Nu);
}
function nr(e, i = !1) {
  return i ? Lu(e) : pt(e);
}
...
function Ru(e) {
  let i = pt(e);
  return i.endsWith("  }]") && (i = aa(i)), i;
}
function Ou(e) {
  let i = pt(e, !0);
  return i.startsWith("[    ") && (i = i.replace("[    ", "[")), i;
}
var bs = (e) => e.$$typeof === Symbol.for("react.memo"),
  Vu = (e) => e.$$typeof === Symbol.for("react.forward_ref"),
  Cr = { ...q, JSXElement: () => {} },
  Fu = Te.extend(po());
function ri(e) {
...
function Uu(e) {
  ...
  return ri(i) === "shape" ? _s(e.arguments[0]) : null;
}
function _s(e) {
  return { inferredType: { type: "Object", depth: Ss(e) }, ast: e };
}
function Gu(e) {
  return { inferredType: { type: "Array", depth: Ss(e) }, ast: e };
}
function Wu(e) {
  switch (e.type) {
    case "Identifier":
...
function Es(e, i) {
  ...
  switch (o) {
    ...
    case "Element": {
      let { identifier: v } = r;
      (l = v != null && !_r(v) ? v : Mt),
        (m = vn(e).length === 1 ? e : null),
        (x = e);
      break;
    }
    case "Array": {
      let { depth: v } = r;
      (l = Sr), (m = v <= 2 ? yn(s, !0) : null), (x = yn(s));
      break;
    }
    default:
      (l = Qu(o)), (m = vn(e).length === 1 ? e : null), (x = e);
      break;
  }
...
function Xu({ raw: e }) {
  return e != null
    ? Es(e, "custom")
    : Ve({ name: "custom", short: rr, compact: rr });
}
function Ju(e) {
  let { jsDocTags: i } = e;
  return i != null && (i.params != null || i.returns != null)
    ? Ve({
        name: "func",
        short: Au(i.params, i.returns),
        compact: null,
        full: ku(i.params, i.returns),
      })
...
function Zu({ value: e, computed: i }) {
  return i
    ? Es(e, "enumvalue")
...
function eh(e) {
  if (Array.isArray(e.value)) {
    let i = e.value.reduce(
      (r, s) => {
        let { short: o, compact: l, full: m } = Zu(s);
...
function th(e, i) {
  ...
  if (r === "custom") {
    if (m === "Object") return Sn(s, o, l);
  } else if (r === "shape") return Sn(s, o, l);
  return Ve({ name: "arrayOf", short: sr(s), compact: sr(s) });
}
function Ft(e, i) {
  try {
    switch (e.name) {
  ...
  try {
    switch (i.name) {
      ...
      case "arrayOf": {
        ...
        return s != null && !sa(s) ? be(s) : o ? be(r, o) : be(r);
      }
      case "func": {
        let { short: r, full: s } = Ft(i, e),
          o = r,
          l;
        return s && s.length < Hu ? (o = s) : s && (l = Iu(s)), be(o, l);
      }
      default:
        return null;
    }
...
function ws({ inferredType: e, ast: i }) {
  let { depth: r } = e;
  if (r === 1) {
    let s = nr(i, !0);
    if (!$t(s)) return be(s);
...
function ks({ inferredType: e, ast: i }) {
  let { depth: r } = e;
  if (r <= 2) {
    let s = gn(i, !0);
    if (!$t(s)) return be(s);
...
function rh({ inferredType: e, ast: i }) {
  let { identifier: r } = e;
  if (r != null) return be(As(e), pt(i));
  let s = pt(i, !0);
...
function ah(e) {
  ...
  if (Lo(i) && _r(i)) {
    let o = Ht(e, { tabStop: 0 }).replace(/\r?\n|\r/g, "");
    if (!$t(o)) return be(o);
  }
  return be(Mt, s);
}
var oh = (e) => {
    if (Ps(e) && e.type != null) return ah(e);
    if (wo(e)) {
  ...
  hh = (e) => be(e.toString()),
  Ns = { string: sh, object: oh, function: uh, default: hh };
function lh(e = {}) {
  return { ...Ns, ...e };
}
function Ls(e, i, r = Ns) {
  try {
    switch (typeof e) {
      case "string":
        return r.string(e, i);
...
function mh(e, i) {
  let r = i.defaultProps != null ? i.defaultProps : {},
    s = e.map((o) => dh(o, r[o.propDef.name]));
  return ch(s, i);
}
function gh(e, i) {
  let { propDef: r } = e,
...
Object.keys(Hr).forEach((e) => {
  let i = Hr[e];
  _n.set(i, e), _n.set(i.isRequired, e);
});
function vh(e, i) {
  let r = e;
  !ra(e) && !e.propTypes && bs(e) && (r = e.type);
  let s = na(r, i);
...
var Sh = (e, i) => {
    if (typeof e > "u")
      return gi.warn("Too many skip or undefined component"), null;
    let r = e,
      s = r.type;
    for (let l = 0; l < i.skip; l += 1) {
      if (typeof r > "u") return gi.warn("Cannot skip undefined element"), null;
      if (st.Children.count(r) > 1)
        return gi.warn("Trying to skip an array of elements"), null;
      typeof r.props.children > "u"
        ? (gi.warn("Not enough children to skip elements."),
      ...
      ...(typeof i.displayName == "string"
        ...
        : {
            displayName: (l) =>
              ...
              ia(l.type, "displayName") ||
              (l.type.name !== "_default" ? l.type.name : null) ||
              (typeof l.type == "function" ? "No Display Name" : null) ||
              (Vu(l.type) ? l.type.render.name : null) ||
              (bs(l.type) ? l.type.type.name : null) ||
              l.type,
          }),
    ...
    return st.Children.map(e, (l) => {
      let m = typeof l == "number" ? l.toString() : l,
        x = (typeof Ht == "function" ? Ht : Ht.default)(ar(m), o);
      if (x.indexOf("&quot;") > -1) {
        let v = x.match(/\S+=\\"([^"]*)\\"/g);
        v &&
          v.forEach((C) => {
...
`
  ...
  _h = { skip: 0, showFunctions: !1, enableBeautify: !0, showDefaultProps: !1 },
  Ch = (e) => {
    var s;
    let i =
    ...
    return (i == null ? void 0 : i.type) === Ur.DYNAMIC
      ? !1
      : !r ||
          (i == null ? void 0 : i.code) ||
          (i == null ? void 0 : i.type) === Ur.CODE;
  },
  Eh = (e) => {
    var i, r;
    return (
  ...
  Rs = (e) => {
    ...
    let { mdxType: i, originalType: r, children: s, ...o } = e.props,
      l = [];
    return (
      s && (l = (Array.isArray(s) ? s : [s]).map(Rs)),
  ...
  Os = (e, i) => {
    ...
    wu(() => {
      if (!s) {
        ...
        r.emit(ea, { id: I, source: o, args: k });
      }
    });
    let l = e();
    if (s) return l;
    let m = { ..._h, ...((i == null ? void 0 : i.parameters.jsx) || {}) },
      x =
        (A =
  ...
  wh = {
    docs: {
      story: { inline: !0 },
      extractArgTypes: bh,
      extractComponentDescription: ta,
    },
  },
  Oh = [Os],
  Vh = [Zs],
  Fh = (e, i) => {
    let r = i.findIndex((o) => o.originalFn === Os),
      s = r === -1 ? i : [...i.splice(r, 1), ...i];
    return Cu(e, s);
  },
  Mh = { renderer: "react", ...wh };
export {
  Fh as applyDecorators,
  Vh as argTypesEnhancers,
  Oh as decorators,
  Mh as parameters,
  Lh as render,
  Rh as renderToCanvas,
};
//# sourceMappingURL=config-94358c07.js.map
