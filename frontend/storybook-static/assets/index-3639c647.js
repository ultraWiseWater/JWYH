...
var L = ((n) => (
  ...
  B = (n) => {
    ...
    return !(
      !I(s) || Object.prototype.hasOwnProperty.call(s, "isPrototypeOf") === !1
    );
  },
  k = (n) => {
    try {
  ...
  w = (n, s = !1) => {
    ...
    if (!c.length) return;
    let h = new Map(
      Array.from(n.callRefsByResult.entries()).filter(([, i]) => i.retain)
    );
  ...
  P = class {
    constructor() {
      (this.initialized = !1),
        ...
        (this.state =
          f.window.parent.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER_STATE__ ||
          {});
      ...
      this.channel.on(E, n),
        this.channel.on(C, ({ storyId: e, newPhase: r }) => {
          ...
          this.setState(e, { renderPhase: r }),
            ...
            r === "errored" &&
              this.setState(e, { isLocked: !1, isPlaying: !1 });
        }),
        this.channel.on(D, () => {
      ...
      let s = ({ storyId: e, playUntil: r }) => {
        ...
        c = ({ storyId: e }) => {
          ...
          let r = this.getLog(e).filter((o) => !o.ancestors.length),
            t = r.reduceRight(
              (o, d, _) => (o >= 0 || d.status === "waiting" ? o : _),
              -1
            );
          s({
            storyId: e,
            playUntil: (a = r[t - 1]) == null ? void 0 : a.callId,
          });
        },
        h = ({ storyId: e, callId: r }) => {
          ...
          if (!d && _ && Object.values(o).length > 0) {
            let u =
              (g = this.getLog(e).find((O) => O.status === "waiting")) == null
                ? void 0
                : g.callId;
            _.id !== u && this.setState(e, { playUntil: _.id }),
              Object.values(o).forEach((O) => O());
        ...
        i = ({ storyId: e }) => {
          ...
          if (Object.values(r).length > 0) Object.values(r).forEach((a) => a());
            ...
            let a =
              (t = this.getLog(e).find((o) => o.status === "waiting")) == null
                ? void 0
                : t.callId;
          ...
          return typeof e != "function"
            ...
            : ((i[l] = (...r) => this.track(l, e, r, s)),
              ...
              Object.keys(e).length > 0 &&
                Object.assign(
                  i[l],
                  this.instrument({ ...e }, { ...s, path: h.concat(l) })
                ),
              i);
        },
        c ? n : k(n)
    ...
    track(n, s, c, h) {
      ...
      let i =
          ...
          ((y =
            (S =
              (O = f.__STORYBOOK_PREVIEW__) == null
                ? void 0
                : O.selectionStore) == null
              ? void 0
              : S.selection) == null
            ? void 0
            : y.storyId),
    ...
    intercept(n, s, c) {
      let {
          ...
          isDebugging: i,
          playUntil: l,
        } = this.getState(s.storyId),
        e = h.has(s.id);
      return !i || e || l
        ? (l === s.id && this.setState(s.storyId, { playUntil: void 0 }),
          this.invoke(n, s, c))
        : new Promise((r) => {
            this.setState(s.storyId, ({ resolvers: t }) => ({
              isLocked: !1,
              resolvers: { ...t, [s.id]: r },
            }));
          }).then(
    ...
    invoke(n, s, c) {
      let { callRefsByResult: h, renderPhase: i } = this.getState(s.storyId),
        l = (t) => {
          ...
          if (t instanceof Date)
            return { __date__: { value: t.toISOString() } };
          ...
          return typeof t == "function"
            ...
            : typeof t == "object" &&
              ...
              a.name &&
              ((o = t == null ? void 0 : t.constructor) == null
                ? void 0
                : o.name) !== "Object"
      ...
      try {
        ...
        let t = (
            c.getArgs ? c.getArgs(s, this.getState(s.storyId)) : s.args
          ).map((o) =>
            typeof o != "function" || Object.keys(o).length
              ? o
              : (...d) => {
                  let { cursor: _, ancestors: g } = this.getState(s.storyId);
                  this.setState(s.storyId, {
                    cursor: 0,
                    ancestors: [...g, s.id],
                  });
                  let u = () =>
                      this.setState(s.storyId, { cursor: _, ancestors: g }),
                    O = !1;
                  try {
                    let S = o(...d);
        ...
        return (
          ...
          this.update({
            ...e,
            status: a instanceof Promise ? "active" : "done",
          }),
          a instanceof Promise
            ? a.then((o) => (this.update({ ...e, status: "done" }), o), r)
            : a
        );
      } catch (t) {
        return r(t);
    ...
    update(n) {
      this.channel.emit(p.CALL, n),
        this.setState(n.storyId, ({ calls: s }) => {
          let c = s
            .concat(n)
            .reduce((h, i) => Object.assign(h, { [i.id]: i }), {});
          return {
            calls: Object.values(c).sort((h, i) =>
              h.id.localeCompare(i.id, void 0, { numeric: !0 })
            ),
          };
        }),
        this.sync(n.storyId);
    ...
    sync(n) {
      let s = () => {
        ...
        let { isLocked: c, isPlaying: h } = this.getState(n),
          ...
          l =
            (a = i
              .filter(({ ancestors: o }) => !o.length)
              .find((o) => o.status === "waiting")) == null
              ? void 0
              : a.callId,
        ...
        let r = i.some((o) => ["done", "error"].includes(o.status)),
          t = {
            controlStates: { start: r, back: r, goto: !0, next: h, end: h },
            logItems: i,
            pausedAt: l,
          };
      ...
      this.setState(
        n,
        ({ syncTimeout: c }) => (
          clearTimeout(c), { syncTimeout: setTimeout(s, 0) }
        )
      );
    }
  };
function M(n, s = {}) {
  ...
  try {
    let e = !1,
      r = !1;
    return (
      (h = (c = f.window.location) == null ? void 0 : c.search) != null &&
      h.includes("instrument=true")
        ? (e = !0)
        : (l = (i = f.window.location) == null ? void 0 : i.search) != null &&
      ...
      (f.window.parent === f.window && !e) || r
        ...
        : (f.window.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER__ ||
          ...
          f.window.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER__.instrument(
            n,
            s
          ))
    );
