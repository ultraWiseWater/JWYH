import { _ as wi, b as Wi } from "./index-4cee5db1.js";
                  ...
                  if (
                    ...
                    if (((z = {}), In || pn || hn))
                      if (pr && sr) {
                        var bi = Ar.css(Bn),
                          Fc = A.round(
                            Ar.css(Bn, Q).css(hr, Q).position().left
                          );
                        Ar.css(Bn, bi);
...
var Fi = Ui;
export { Ui as OverlayScrollbarsComponent, Fi as default };
//# sourceMappingURL=OverlayScrollbars-VAV6LJAB-9a185a48.js.map
