try {
  ...
  var Pc = F((uU, Rc) => {
    ...
    function vv(e, t, r, n, a, o) {
      ...
      if (g && !y)
        return (
          o || (o = new Do()),
          u || Av(e) ? mv(e, t, r, n, a, o) : yv(e, t, s, r, n, a, o)
        );
      if (!(r & Ev)) {
  ...
  var bn = F((hH, Op) => {
    ...
    function cx(e, t, r) {
      var n = e[t];
      (!(lx.call(e, t) && ix(n, r)) || (r === void 0 && !(t in e))) &&
        ux(e, t, r);
    }
    Op.exports = cx;
  });
  ...
  var $p = F((MH, Lp) => {
    ...
    function Ix(e) {
      ...
      var t = _x(e),
        r = [];
      for (var n in e)
        (n == "constructor" && (t || !Px.call(e, n))) || r.push(n);
      return r;
    }
    Lp.exports = Ix;
  });
  ...
  var zf = F((RV, Uf) => {
    ...
    function Fn(e, t, r, n, a, o) {
      ...
      if (y) {
        ...
        if (A == $f || A == qf || (g && !a)) {
          if (((u = s || g ? {} : g5(e)), !i))
            return s ? l5(e, o5(u, e)) : s5(e, a5(u, e));
        } else {
          if (!le[A]) return a ? e : {};
          u = h5(e, A, i);
        }
  ...
  var nh = F((fX, rh) => {
    ...
    rh.exports = function () {
      return (
        { __proto__: th }.foo === th.foo && !({ __proto__: null } instanceof WB)
      );
    };
  });
  var oh = F((yX, ah) => {
    ...
    c();
    p();
    var VB = "Function.prototype.bind called on incompatible ",
      Zo = Array.prototype.slice,
      KB = Object.prototype.toString,
      YB = "[object Function]";
    ah.exports = function (t) {
      var r = this;
      if (typeof r != "function" || KB.call(r) !== YB)
        throw new TypeError(VB + r);
      for (
  ...
  var Un = F((TX, fh) => {
    ...
    var tu = function () {
      ...
      Ee =
        ...
        (ZB
          ...
          : null),
      Wt = {},
      eT = typeof Uint8Array > "u" || !Ee ? ee : Ee(Uint8Array),
      vt = {
    ...
    var lh,
      ...
      Ir = qn(),
      Ln = sh(),
      rT = Ir.call(Function.call, Array.prototype.concat),
      nT = Ir.call(Function.apply, Array.prototype.splice),
  ...
  var Ch = F((jX, vh) => {
    ...
    var Eh = Un(),
      Dh = Ah(),
      cT = Dh(Eh("String.prototype.indexOf"));
  ...
  var Hh = F((WX, zh) => {
    ...
    var du = typeof Map == "function" && Map.prototype,
      ...
      jr = dT ? WeakSet.prototype.has : null,
      fT = typeof WeakRef == "function" && WeakRef.prototype,
      wh = fT ? WeakRef.prototype.deref : null,
    ...
    zh.exports = function e(t, r, n, a) {
      ...
      if (IT(t)) {
        for (
          var x = "<" + Bh.call(String(t.nodeName)),
            S = t.attributes || [],
            P = 0;
          P < S.length;
          P++
        )
          x += " " + S[P].name + "=" + qh(ET(S[P].value), "double", o);
        return (
          (x += ">"),
      ...
      if (vT(t)) {
        ...
        return !("cause" in Error.prototype) &&
          ...
          ? "{ [" +
              String(t) +
              "] " +
              We.call(Th.call("[cause]: " + g(t.cause), $), ", ") +
              " }"
          : $.length === 0
          ? "[" + String(t) + "]"
          : "{ [" + String(t) + "] " + We.call($, ", ") + " }";
      ...
      if (typeof t == "object" && u) {
        if (Ih && typeof t[Ih] == "function" && lu)
          return lu(t, { depth: y - n });
      ...
      if (xT(t)) return kr(g(Number(t)));
      if (ST(t)) return kr(g(iu.call(t)));
      if (FT(t)) return kr(hT.call(t));
      if (CT(t)) return kr(g(String(t)));
      if (!DT(t) && !kh(t)) {
        var I = Hn(t, g),
          U = Oh
    ...
    function kT(e) {
      ...
      return r
        ? "\\" + r
        : "\\x" + (t < 16 ? "0" : "") + bT.call(t.toString(16));
    }
    function kr(e) {
      return "Object(" + e + ")";
    }
...
` +
    ...
    function Hn(e, t) {
      ...
      if (typeof ou == "function")
        for (var d = 0; d < o.length; d++)
          Mh.call(e, o[d]) && n.push("[" + t(o[d]) + "]: " + t(e[o[d]], e));
      return n;
    }
  });
  var Wh = F((XX, Gh) => {
    ...
    var gu = Un(),
      ...
      $T = Jt("WeakMap.prototype.set", !0),
      UT = Jt("WeakMap.prototype.has", !0),
      zT = Jt("Map.prototype.get", !0),
      HT = Jt("Map.prototype.set", !0),
      GT = Jt("Map.prototype.has", !0),
      mu = function (e, t) {
  ...
  var tg = F((sJ, eg) => {
    ...
    var Qh = Wh(),
      ...
      Eu = {},
      d8 = function e(t, r, n, a, o, u, i, s, d, y, A, g, h, E, b, x) {
        for (
          var S = t, P = x, N = 0, $ = !1;
          (P = P.get(Eu)) !== void 0 && !$;
        ...
        for (
          var z = a && tt(S) && S.length === 1 ? r + "[]" : r, ie = 0;
          ie < U.length;
          ++ie
        ) {
          var Z = U[ie],
      ...
      f8 = function (t) {
        ...
        if (typeof t.format < "u") {
          if (!s8.call(Mr.formatters, t.format))
  ...
  var ag = F((dJ, ng) => {
      ...
      b8 = function (t, r) {
        ...
        if (r.charsetSentinel)
          for (s = 0; s < u.length; ++s)
            u[s].indexOf("utf8=") === 0 &&
              (u[s] === y8 ? (d = "utf-8") : u[s] === m8 && (d = "iso-8859-1"),
              (i = s),
              (s = u.length));
        for (s = 0; s < u.length; ++s)
          if (s !== i) {
            var y = u[s],
              ...
              E;
            g === -1
              ? ((h = r.decoder(y, De.decoder, d, "key")),
    ...
    ng.exports = function (e, t) {
      ...
      for (
        var n = typeof e == "string" ? b8(e, r) : e,
...
`;
      ...
      function U() {
        ...
        for (
          ...
          if (u === t.REST) {
            (k = a - 3),
              w(t.REST),
              B.push(E({ type: e.RestType, expression: K() }, [k, o]));
            break;
          } else B.push(K());
      ...
      function ie() {
        ...
        return (
          (k = a), j(t.RBRACE), E({ type: e.RecordType, fields: B }, [R, k])
        );
      }
      function Z() {
        var B = i,
        ...
        for (var B = [], R = !1, k, _ = !1, L, H = a - 3, de; u !== t.RPAREN; )
          u === t.REST && (w(t.REST), (_ = !0)),
            ...
            k.type === e.NameExpression &&
              ...
              ((de = o - k.name.length),
              w(t.COLON),
              (k = E({ type: e.ParameterType, name: k.name, expression: K() }, [
                de,
                o,
              ]))),
            u === t.EQUAL
...
\u2028\u2029])`;
      ...
      function $(w, j) {
        for (
          var I = w.replace(/^\/\*\*?/, ""), U = 0, V = new RegExp(P, "g"), z;
          (z = V.exec(I));
          ...
          if (de) {
            if ((Q(k), z.charCodeAt(I) === 61)) {
              ...
              for (var ue, Ae = 1; I < k; ) {
                if (
                  ((ue = z.charCodeAt(I)),
                  n.code.isWhiteSpace(ue) &&
                    (ae || (Q(k), (ue = z.charCodeAt(I)))),
                  ue === 39 && (ae ? ae === "'" && (ae = "") : (ae = "'")),
                  ue === 34 && (ae ? ae === '"' && (ae = "") : (ae = '"')),
                  ue === 91)
                )
  ...
  var Ne,
    ...
    Im = Xe(() => {
      ...
      La();
      cr();
      (P4 = q.div({ position: "relative", maxWidth: 250 })),
        (I4 = q(Xr)({ position: "absolute", zIndex: 1, top: 4, left: 4 })),
        (k4 = q.div({
          width: 200,
          margin: 5,
        ...
        (Om = ((e) => ((e.RGB = "rgb"), (e.HSL = "hsl"), (e.HEX = "hex"), e))(
          Om || {}
        )),
        (ua = Object.values(Om)),
        ...
        (K4 = (e, t) => {
          ...
          let s = rt(() => V4(r, a, u).toLowerCase(), [r, a, u]),
            d = ge(
              (A) => {
                let g = or(A),
                  h = g?.value || A || "";
  ...
  function z2(e, t) {
    ...
    var r = nt(t);
    return at(
      Fe({}, r, { saturation: Rt(0, 1, r.saturation - parseFloat(e)) })
    );
  }
  var Ck = Ie(z2);
  function H2(e, t) {
  ...
  function Q2(e, t) {
    return t === "transparent"
      ? t
      : at(Fe({}, nt(t), { lightness: parseFloat(e) }));
  }
  var Sk = Ie(Q2);
  function Z2(e, t) {
    return t === "transparent"
      ? t
      : at(Fe({}, nt(t), { saturation: parseFloat(e) }));
  }
  var wk = Ie(Z2);
  function e1(e, t) {
                ...
                j = (b[w] = (function (I, U) {
                  return I === "style"
                    ? U.split(/;\s?/).reduce(function (V, z) {
                        ...
                        return (
                          (V[
                            ie.replace(/(-[a-z])/g, (Z) => Z[1].toUpperCase())
                          ] = z.slice(ie.length + 1).trim()),
                          V
                        );
                      }, {})
                    : I === "href"
                    ? Ut(U)
                    : (U.match(vF) && (U = U.slice(1, U.length - 1)),
                      U === "true" || (U !== "false" && U));
                })(N, $));
              typeof j == "string" &&
                (qo.test(j) || Lo.test(j)) &&
    ...
    let u = [],
      ...
      s = {
        ...
        footnoteReference: {
          ...
          h: (h, E, b) =>
            n("a", { key: b.k, href: Ut(h.R) }, n("sup", { key: b.k }, h.$)),
        },
        gfmTask: {
          t: it(AF),
          i: te.HIGH,
        ...
        link: {
          ...
          h: (h, E, b) =>
            n("a", { key: b.k, href: Ut(h.R), title: h.N }, E(h.$, b)),
        },
        ...
        refLink: {
          ...
          h: (h, E, b) =>
            i[h.F]
              ? n(
                  "a",
                  { key: b.k, href: Ut(i[h.F].R), title: i[h.F].N },
                  E(h.$, b)
                )
...
`
  ...
  var C3 = Object.create,
    ...
    Ge = (e, t) =>
      function () {
        return (
          t || (0, e[Xf(e)[0]])((t = { exports: {} }).exports, t), t.exports
        );
      },
    w3 = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
...
`,
      ...
      `),
          ...
          : (r.add(e),
            Array.isArray(e)
              ...
              : {
                  name: "object",
                  value: (0, Or.default)(e, (a) => Xo(a, t, new Set(r))),
                })
        : { name: "object", value: {} };
    },
    zB = (e) => {
  ...
  var G0 = (e, t) => (Array.isArray(t) ? t.includes(e) : e.match(t)),
    ...
    Y0 = (e) => {
      ...
      if (!r) return t;
      let u = Pr(t, n, a),
        i = (0, Or.default)(u, (s, d) => s?.type && HB(s, d, o));
      return Et(i, u);
    };
  Y0.secondPass = !0;
  function Jo(e) {
    ...
    ig = Ge({
      "../../node_modules/entities/lib/encode.js"(e) {
        ...
        function d(P) {
          ...
          return (
            $.unshift("[" + N.join("") + "]"), new RegExp($.join("|"), "g")
          );
        }
        var y =
            /(?:[\x80-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])/g,
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
                ...
                value: function (T) {
                  ...
                  return (
                    ...
                    ie(T.join(""), Y, function (Q, se) {
                      var Re = E(G, Q, se, Y);
                      Re && K.push(Re),
                        Y.stream && (M.stickyStack = Z(M.stickyStack, Q, se));
                    }),
                    G.length && K.push(S(G)),
                    K.join("")
                  );
  ...
  var zJ = new j8.default({ escapeXML: !0 });
  var { document: HJ } = oe;
  l();
  c();
  p();
  ...
  var q8 = Object.create,
    ...
    ke = (e, t) =>
      function () {
        return (
          t || (0, e[pg(e)[0]])((t = { exports: {} }).exports, t), t.exports
        );
      },
    z8 = (e, t, r, n) => {
      if ((t && typeof t == "object") || typeof t == "function")
          ...
          for (var Re = 1, Pe = !0; Re < T.length; Re += 1) {
            ...
            if (
              ...
              if (i && Re + 1 >= T.length) {
                var R = i(K, J);
                (Pe = !!R),
                  Pe && "get" in R && !("originalValue" in R.get)
                    ? (K = R.get)
                    : (K = K[J]);
              } else (Pe = P(K, J)), (K = K[J]);
              Pe && !Q && (E[Y] = K);
  ...
  var a_ =
      typeof window == "object" && window && window.Object === Object && window,
    o_ = a_,
    u_ = typeof self == "object" && self && self.Object === Object && self,
    i_ = o_ || u_ || Function("return this")(),
    xu = i_,
    s_ = xu.Symbol,
    Zt = s_,
    Dg = Object.prototype,
    l_ = Dg.hasOwnProperty,
    c_ = Dg.toString,
  ...
  function A6(e) {
    var t = this.__data__;
    return Lr ? t[e] !== void 0 : b6.call(t, e);
  }
  var E6 = A6,
    D6 = "__lodash_hash_undefined__";
  function v6(e, t) {
  ...
  tr.prototype.clear = F6;
  tr.prototype.delete = _6;
  tr.prototype.get = R6;
  tr.prototype.has = I6;
  tr.prototype.set = N6;
  var j6 = tr,
  ...
  rr.prototype.clear = $6;
  rr.prototype.delete = W6;
  rr.prototype.get = K6;
  rr.prototype.has = X6;
  rr.prototype.set = Q6;
  var Sg = rr,
...
` &&
      ...
      m.createElement(
        ...
        m.createElement(
          ...
          e
            ...
            : m.createElement(t9, { zoom: n, resetZoom: a })
        )
      ),
    ey = sr({ scale: 1 }),
    { window: a9 } = oe,
  ...
  var g9 = q(n9)({
    ...
    m9 = q.div({ overflow: "hidden", position: "relative" }),
    Xu = ({
      isLoading: e,
      isColumn: t,
      columns: r,
      ...
      let [A, g] = ne(u),
        { source: h, actionItem: E } = f9(a, A, g),
        [b, x] = ne(1),
        ...
        I = ge(async (V) => {
          let { createCopyToClipboardFunction: z } =
            await Promise.resolve().then(() => (cr(), vi));
          z();
        }, []),
        U = (V) => {
    ...
    F9 = q(Te)({ height: 10, width: 10, minWidth: 10, marginLeft: 4 }),
    S9 = () => m.createElement("span", null, "-"),
    ty = ({ text: e, simple: t }) => m.createElement(D9, { simple: t }, e),
    w9 = (0, Xm.default)(1e3)((e) => {
      let t = e.split(/\r?\n/);
    ...
    jm = (e, t = !0) => {
      ...
      return (
        t || (r = e.slice(0, Ju)),
        r.map((n) => m.createElement(ty, { key: n, text: n === "" ? '""' : n }))
      );
    },
    T9 = ({ value: e, initialExpandedArgs: t }) => {
      ...
      return m.createElement(
        ...
        m.createElement(
          ...
          m.createElement(F9, { icon: a ? "arrowup" : "arrowdown" })
        )
      );
    },
    Hu = ({ value: e, initialExpandedArgs: t }) =>
      e == null
        ? m.createElement(S9, null)
        : m.createElement(T9, { value: e, initialExpandedArgs: t }),
    _9 = q.label(({ theme: e }) => ({
      lineHeight: "18px",
      alignItems: "center",
      marginBottom: 8,
      ...
      span: {
        ...
        background: "transparent",
        "&:hover": {
          boxShadow: `${gr(0.3, e.appBorderColor)} 0 0 0 1px inset`,
        },
        "&:active": {
    ...
    O9 = (e) => e === "true",
    R9 = ({ name: e, value: t, onChange: r, onBlur: n, onFocus: a }) => {
      let o = ge(() => r(!1), [r]);
      if (t === void 0)
        return m.createElement(
          Be.Button,
    ...
    M9 = ({ name: e, value: t, onChange: r, onFocus: n, onBlur: a }) => {
      ...
      me(() => {
        o !== !1 &&
          (i && i.current && (i.current.value = k9(t)),
          s && s.current && (s.current.value = N9(t)));
      }, [t]);
      let d = (g) => {
  ...
  var $9 = ({
    ...
    Mm = ({ name: e, options: t, value: r, onChange: n, isInline: a }) => {
      if (!t)
        return (
          qe.warn(`Checkbox with no options: ${e}`),
    ...
    qm = ({ name: e, options: t, value: r, onChange: n, isInline: a }) => {
      if (!t)
        return (
          qe.warn(`Radio with no options: ${e}`),
          m.createElement(m.Fragment, null, "-")
        );
      let o = ry(r, t),
        u = _e(e);
    ...
    $m = (e) => {
      ...
      return r
        ...
        : (qe.warn(`Select with no options: ${t}`),
          m.createElement(m.Fragment, null, "-"));
    },
    J9 = (e, t) =>
      Array.isArray(e)
    ...
    handleAddValueAdd({ key: e, newValue: t }) {
      ...
      o(e, n, a, t)
        .then(() => {
          ...
          let { onUpdate: i, onDeltaUpdate: s } = this.props;
          i(n[n.length - 1], r),
            s({ type: uy, keyPath: n, deep: a, key: e, newValue: t });
        })
        .catch(u.error);
    }
    handleRemoveValue(e) {
  ...
  var { window: gR } = oe,
        ...
        u
          ...
          : m.createElement(dy, {
              ...
              inputElement: (x, S, P, N) =>
                N
                  ? m.createElement(zm, { onFocus: DR, onBlur: ER })
                  : m.createElement(zm, null),
              fallback: b,
            })
      );
    },
    ...
    xR = q(fy)(({ numberOFDecimalsPlaces: e, max: t }) => ({
  ...
  var PR = ({ onChange: e, name: t, accept: r = "image/*", value: n }) => {
    ...
    ca = (e) => {
      ...
      return m.createElement(
        ...
        m.createElement(
          zR,
          { expandable: a },
          m.createElement(MR, null, u),
          A ? m.createElement(qR, { title: "Required" }, "*") : null
        ),
        n
          ? null
          : m.createElement(
              "td",
              null,
              g && m.createElement(LR, null, m.createElement(zo, null, i)),
              s.jsDocTags != null
                ? m.createElement(
                    m.Fragment,
                    null,
                    ...
                    m.createElement(E9, { tags: s.jsDocTags })
                  )
                : m.createElement(
                    $R,
                    { hasDescription: g },
      ...
      return m.createElement(
        ...
        m.createElement(
          ...
          m.createElement(
            ...
            m.createElement(GR, null, m.createElement(HR, { icon: y }), t)
          ),
          m.createElement(
            KR,
            { colSpan: a - 1 },
    ...
    QR = q.span({ display: "flex", justifyContent: "space-between" }),
    ZR = {
    ...
    eP = { rows: { row1: Vu("row1"), row2: Vu("row2"), row3: Vu("row3") } },
    tP = (e, t) => {
    ...
    Bte = q.div(Tt, ({ theme: e }) => ({
      ...da(e),
      margin: "25px 0 40px",
      padding: "30px 20px",
    }));
  var Tte = q.div(({ theme: e }) => ({
      fontWeight: e.typography.weight.bold,
      color: e.color.defaultText,
    })),
    _te = q.div(({ theme: e }) => ({
    ...
    Ote = q.div({ flex: "0 0 30%", lineHeight: "20px", marginTop: 5 }),
    Rte = q.div(({ theme: e }) => ({
      flex: 1,
      textAlign: "center",
      fontFamily: e.typography.fonts.mono,
    ...
    Pte = q.div({ display: "flex", flexDirection: "row" }),
    Ite = q.div(({ background: e }) => ({
      position: "relative",
      flex: 1,
      "&::before": {
        position: "absolute",
    ...
    jte = q.div({ flex: 1, display: "flex", flexDirection: "row" }),
    Mte = q.div({ display: "flex", alignItems: "flex-start" }),
    qte = q.div({ flex: "0 0 30%" }),
    Lte = q.div({ flex: 1 }),
    $te = q.div(({ theme: e }) => ({
      display: "flex",
      flexDirection: "row",
  ...
  var zte = q.div(({ theme: e }) => ({
    ...
    Wte = q.div({ display: "flex", flexFlow: "row wrap" });
  var aP = (e) => `anchor--${e}`,
    oP = ({ storyId: e, children: t }) =>
      m.createElement("div", { id: aP(e), className: "sb-anchor" }, t);
  oe &&
  ...
  var iP = (e, t) => {
      ...
      let o = ge(
          (i) => t.channel.emit(_n, { storyId: e, updatedArgs: i }),
          [e]
        ),
    ...
    ei = (e, t, r, n, a, o) => ({
      ...e,
      ...(0, Zm.default)(t, (u) => ({ rows: by(u, r, n, a), sort: o })),
    }),
    cP = (e) => {
      let t = je(Ye),
        {
...
`));
  ...
  var Ey = (e, t) => {
    ...
    vP = (e) => {
      ...
      let { isLoading: u, previewProps: i } = DP(e, t, r),
        s,
        d,
        y;
      try {
  ...
  var ti = ka.a,
    ...
    FP = (e) => {
      let { href: t, target: r, children: n, ...a } = e,
        o = je(Ye);
      if (t) {
        if (t.startsWith("#")) return m.createElement(xP, { hash: t }, n);
    ...
    RP = (e) => e && (typeof e == "string" ? e : ra(e.markdown) || ra(e.text)),
    PP = (e) => e && (typeof e == "string" ? e : ra(e.text)),
    IP = (e) => null,
    kP = (e) => {
      switch (e.type) {
        case "story":
    ...
    jP = (e) => {
      ...
      let o = je(Ye),
        ...
        i;
      return (
        r || n || a ? (i = NP(e, o)) : (i = kP(u)),
        r &&
          ye(`Manually specifying description type is deprecated. See ${pa}`),
        n &&
          ye(
            `The 'markdown' prop on the Description block is deprecated. See ${pa}`
          ),
        a &&
          ye(
            `The 'children' prop on the Description block is deprecated. See ${pa}`
          ),
        i ? m.createElement(_P, null, i) : null
      );
    },
    { document: Vte, window: Kte } = oe;
      ...
      return m.createElement(
        ...
        t &&
          m.createElement(
            m.Fragment,
            null,
            m.createElement(MP, null, o.name),
            m.createElement(jP, { of: e })
          ),
        m.createElement(vP, {
          of: e,
          withToolbar: u,
